...
public class IpBlacklistFilter implements GlobalFilter { //GlobalFilter implemetasyonu  istek geldigi gibi bunu calistirir
    ...
    // ex.getRequest yaparken aslinda GatewayConfigde @Bean olrak tanilmadigimiz icin kolayca constructor injection yapmadan kullaniyoruz. classi bile olusturmuyoruz.
    // Spring sadece containere bakiyor varmi yokmu varsa otomatik algiliyor.
    @Bean
